...
<header class="fixed-top">
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <a class="navbar-brand" href="Outlet.php?page=home" style="display: flex; align-items: center;">
            <img src="/LWHW/wwwroot/media/logo.png" class="img-fluid" alt="Logo">
        </a>
            ...
            <div class="row">
                <div class="col">
                    ...
                    if ($component->userManager->isCurrentUserAuthenticated())
                        echo "<a href='/LWHW/Outlet.php?page=logout'>Log out</a>";
                    ?>
                </div>
            </div>
...
<body>
<script src="/LWHW/node_modules/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
<script src="/LWHW/node_modules/jquery/dist/jquery.min.js"></script>
<script src="/LWHW/node_modules/slick-carousel/slick/slick.min.js"></script>
<?php
